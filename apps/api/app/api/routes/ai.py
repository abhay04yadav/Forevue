...
The student role is blocked until student identity issuance lands (Ch4 §9).
...
def _ensure_ai_role(current_user: CurrentUser) -> None:

    if current_user.role == "student":

        raise ForbiddenException(

            "The student role cannot use the AI plane until student identity issuance is implemented (Ch4 §9)."
